<?php /* Smarty version 2.6.18, created on 2008-03-27 10:46:07
...
;
var NbPage=<?php echo $this->_tpl_vars['NBPAGES']; ?>
;
var Query='<?php echo $this->_tpl_vars['QUERY']; ?>
';
...
<table width="50%" border="0" align="center" cellpadding="1" cellspacing="5">
    <tr>
	  ...
	  <td><div align="center"> 
	      <?php echo $this->_tpl_vars['ROWS']*$this->_tpl_vars['COLS']*$this->_tpl_vars['PAGE']-$this->_tpl_vars['ROWS']*$this->_tpl_vars['COLS']+1; ?>
-<?php echo $this->_tpl_vars['PAGE']*$this->_tpl_vars['ROWS']*$this->_tpl_vars['COLS']; ?>
/<?php echo $this->_tpl_vars['NBPHOTOS']; ?>
, 
          page 
          <input name="lapage" type="text" value="<?php echo $this->_tpl_vars['PAGE']; ?>
" size="4" maxlength="5">
          /<?php echo $this->_tpl_vars['NBPAGES']; ?>
...
<div align="left">WHERE : <?php echo $this->_tpl_vars['RAWQUERY']; ?>
...
$this->_sections['im']['loop'] = is_array($_loop=$this->_tpl_vars['IM']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?> <?php if (( $this->_tpl_vars['IM'][$this->_sections['im']['index']]['I'] % $this->_tpl_vars['COLS'] ) == 0): ?>
<tr><?php endif; ?>

<td><div align="center"><?php echo $this->_tpl_vars['IM'][$this->_sections['im']['index']]['Date']; ?>
<a href="<?php echo $this->_tpl_vars['IM'][$this->_sections['im']['index']]['Link']; ?>
" target="_blank"><img src="<?php echo $this->_tpl_vars['IM'][$this->_sections['im']['index']]['SmallLink']; ?>
"></a></div></td>

<?php if ($this->_tpl_vars['IM'][$this->_sections['im']['index']]['I']%$this->_tpl_vars['COLS'] == $this->_tpl_vars['COLS']-1): ?></tr><?php endif; ?>
